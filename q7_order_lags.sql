...
FROM (SELECT Id, OrderDate, LAG(OrderDate, 1, OrderDate) OVER (ORDER BY OrderDate) AS PrevOrderDate
FROM 'Order' WHERE CustomerId = 'BLONP' ORDER BY OrderDate LIMIT 10);
